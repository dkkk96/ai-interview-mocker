  ...
  <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
      <div>
        <p>
          ...
          <a href="#" className="block text-2xl font-medium text-primary hover:opacity-75 hover:scale-110 sm:text-3xl transition-all">
            0123456789
          </a>
        </p>
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs text-primary sm:mt-0">
          &copy; 2024. Mockbot Interview. All rights reserved.
        </p>
      </div>
    </div>
  </div>
